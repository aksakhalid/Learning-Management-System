...
if ( $_POST['regno']== "")
	...
	$del_Query="DELETE FROM employee WHERE regno =$data[0]";
...
<p align="center">	<span class="style1">Delete Employee Info </span></p>
  ...
  <tr>
    ...
    <td width="280"><label> </label>
      <div align="left">
          ...
          <input name="btnsearch" type="submit" id="btnsearch" value="Search" class="button">
        </div></td>
  </tr>
</table>
<p align="center">&nbsp;</p>

<table width="991" height="458" align="center">
  <tr>
    <td width="457"><div align="center">
      <p align="center" class="style3"><strong>Basic Info </strong></p>
      </div></td>
  ...
  <tr>
    <td><table width="447" height="217" border="0" align="center">
      <tr>
        <td width="171">Employee First Name </td>
  ...
  <tr>
    <td><table width="457" height="170" border="0" align="center">
      <tr>
        <td width="185">Phone No </td>
    ...
    <td><table width="507" height="98" border="0" align="center">
      <tr>
        <td width="213">Registration Date </td>
        <td width="284"><label> </label>
            <div align="left">
...
<table width="402" height="45" border="0" align="center">
  <tr>
    <td height="41"><label> </label>
      ...
      <div align="center">
        <input name="btndel" type="submit" id="btndel" value="Delete" class="button"/>
        <input name="cancel" type="submit" id="cancel" value="Cancel" class="button" />
      </div></td>
  </tr>
</table>
</form>
